...
export default function ViewCorte3Table({ zona, mes, periodo }: Props) {
    ...
    return (
        <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-purple-50/30 dark:from-slate-900 dark:to-slate-800 overflow-hidden">
            ...
            <CardContent className="p-0">
                <div className="overflow-auto max-h-[500px]">
                    <Table className="text-xs">
                        <TableHeader className="sticky top-0 bg-gradient-to-r from-purple-100 to-violet-100 dark:from-slate-800 dark:to-slate-700 z-10">
                            <TableRow>
